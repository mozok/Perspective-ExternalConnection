...
/**
 * Factory class for @see \Perspective\ExternalConnection\Model\AnotherEntityRepository
 */
class AnotherEntityRepositoryFactory implements RepositoryFactoryInterface
{
    /**
     ...
     * @return AnotherEntityRepositoryInterface
     * @throws ProcessingException
     */
    public function create(string $instanceCode, array $data = []): AnotherEntityRepositoryInterface
    {
